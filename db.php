...
$arrProducts = [
    ...
    $food = new Food(4, 'Croccantini al cinghiale', 'Ottimi croccanti al gusto di cinghiale', $categories[1], 1000, 'percorso immagine', '2023-08-30', 300),
    $toy = new Toy(5, 'Corda', 'Corda per far divertire i vostri cuccioli', $categories[1], 1500, 'percorso immagine', 'Corda', 'Bianco'),
    $shelter = new Kennel(6, 'Cuccia da esterno', 'Bellissima cuccia da esterno per il vostro cane', $categories[1], 3500, 'percorso immagine', 1500, 900, 800),
];
